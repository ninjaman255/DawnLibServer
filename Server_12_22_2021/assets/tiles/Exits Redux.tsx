...
<tileset version="1.5" tiledversion="1.7.1" name="Exits Redux" tilewidth="64" tileheight="40" tilecount="18" columns="3">
 <tileoffset x="0" y="8"/>
 <image source="Exits Redux.png" width="192" height="240"/>
 <tile id="0">
  <animation>
